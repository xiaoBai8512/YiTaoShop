...
(function () {
    ...
    Corouse.prototype.createSingleView = function (imagePath,toUrl) {
        ...
        backgroundImageView.css({display: "block",width:this.width+"px",height:this.height+"px",background:"url("+imagePath+")","background-position":"50% 50%","background-size":"cover","background-repeat":"no-repeat","float":"left"});
    ...
    Corouse.prototype.createControlButton = function () {
         preButton = $("<div class='preButton'><</div>");
    ...
    Corouse.prototype.updataPage = function () {
        var lastPage = $("."+this.backgroundView.attr("class")+" .imageView");
     ...
     * superView:父视图
     * */
    Corouse.prototype.removebuttonControl=function () {
        nextButton.remove();
        preButton.remove();
    }
